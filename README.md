...
> Άνοιγμα αυτής της σελίδας στο [https://katsigaros.github.io/zaria/](https://katsigaros.github.io/zaria/)
...
* αναζήτηση για **https://github.com/katsigaros/zaria** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/katsigaros/zaria/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/katsigaros/zaria** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/katsigaros/zaria/raw/master/.github/makecode/blocks.png)
